        ...
        return(
            ...
            <section className="projects-grid">
                <Grid>
                    ...
                    <Cell col ={3} style={{paddingRight: '100px'}}>
                        <Card shadow={0} style={{width: '312px', margin: 'auto'}}>
                        <CardTitle style={{color: '#000', paddingRight: '30px', height: '306px', background: 'url(https://user-images.githubusercontent.com/10379994/31985754-c56b8dba-b998-11e7-9705-a7f984433049.png) center / cover'}}>Visual Studio Code</CardTitle>
                        <CardText>
                        <p>Description of application</p>
